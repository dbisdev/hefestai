              ...
              <div className="relative w-full h-full bg-black overflow-hidden flex items-center justify-center">
                ...
                {isGenerating && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/40 z-20">
                    ...
                    <span className="text-primary text-[10px] animate-pulse">SIMULANDO_ENCUENTRO...</span>
                  </div>
                )}
              </div>
            ...
            <div className={`border border-primary/30 bg-black p-4 transition-all ${editableData ? 'border-primary' : ''}`}>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <span className="material-icons text-primary text-xl">pest_control</span>
